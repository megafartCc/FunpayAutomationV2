                    ...
                    >
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                          ...
                          {item.last_error ? (
                            <div className="mt-2 rounded-lg border border-rose-200 bg-rose-50 px-2 py-1 text-[11px] text-rose-600">
                              {item.last_error}
                            </div>
                          ) : null}
                        </div>
                ...
                presenceAccounts.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className="grid grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)_minmax(0,0.5fr)] items-center gap-4 rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm"
                    >
                      <div>
