...
DEFAULT_KNOWLEDGE: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "content": (
            ...
            "- !код — получить Steam Guard (таймер аренды стартует после первого кода или через 10 минут автоматически)\n"
    ...
    },
    {
        ...
        "content": "Код Steam Guard выдаётся командой !код. Таймер аренды стартует после первого кода или автоматически через 10 минут.",
    },
    {
        "id": "pause",
