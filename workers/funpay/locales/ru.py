...
access_granted_notification = "<b>🚨 ВНИМАНИЕ! 🚨\n\n\n</b>" * 3 + "\n\n\n🔐 \"<a href=\"\"> {0} </a>\" " \
                                                                 "<b>(ID: {1}) только что получил доступ к ПУ ! 🔓</b>"
...
✅ <i>FPC</i> может видеть изображения в чате и пересылать их в <i></i> чат.
...
❌ <i>FPC</i> не может видеть изображения в чате и пересылать их в <i></i> чат.
...
✅ Ты <b><u>можешь настраивать конфиги</u></b> и полностью <b><u>использовать функционал <i></i> бота</u></b>.\n
...
update_backup = "✅ Резервная копия конфигов, хранилища и плагинов <code>backup.zip</code>.\n\n" \
                "⚠️ НЕ ОТПРАВЛЯЙ этот архив НИКОМУ. Он содержит абсолютно ВСЁ содержимое и настройки бота (в том числе golden_key)."
...
Включить меня через <i></i> ПУ <b><u>не получится!</u></b>"""
...
🔝 Вечный онлайн
📲 Уведомления в 
🕹️ Полноценная панель управления в 
🧩 Плагины
🌟 И многое другое...
...
<b><u>Настройки раздельны для каждого <i></i> чата!</u></b>\n
...
desc_au = "Здесь ты можешь настроить авторизацию в панели управления ."
...
v_edit_notification_text = "Введи новый текст  уведомления."
...
# Логи
log_tg_initialized = "$MAGENTA бот инициализирован."
log_tg_started = "$CYAN бот $YELLOW@{}$CYAN запущен."
log_tg_handler_error = "Произошла ошибка при выполнении хэндлера  бота."
log_tg_update_error = "Произошла ошибка ({}) при получении обновлений  (введен некорректный токен?)."
