...
access_granted_notification = "<b>🚨 УВАГА! 🚨\n\n\n</b>" * 3 + "\n\n\n🔐 \"<a href=\"\"> {0} </a>\" " \
                                                              "<b>(ID: {1}) щойно отримав доступ до ПУ ! 🔓</b>"
...
✅ <i>FPC</i> може бачити зображення в чаті і пересилати їх в <i></i> чат.
...
❌ <i>FPC</i> не може бачити зображення в чаті і пересилати їх у <i></i> чат.
...
✅ Ти <b><u>можеш налаштовувати конфіги</u></b> і повністю <b><u>використовувати функціонал <i></i> бота</u></b>.\n
...
update_backup = "✅ Резервна копія конфігів, сховища і плагінів <code>backup.zip</code>.\n\n" \
                "⚠️ НЕ ВІДПРАВЛЯЙ цей архів НІКОМУ. Він містить абсолютно ВЕСЬ вміст і налаштування бота (в тому числі golden_key)."
...
Увімкнути мене через <i></i> ПУ <b><u>не вийде!</u></b>"""
...
🔝 Вічний онлайн
📲 Сповіщення в 
🕹️ Повноцінна панель управління в 
🧩 Плагіни
🌟 І багато іншого...
...
<b><u>Налаштування роздільні для кожного <i></i> чату!</u></b>\n
...
desc_au = "Тут ти можеш налаштувати авторизацію у ПУ ."
...
v_edit_notification_text = "Введи новий текст  сповіщення."
...
# Логи
log_tg_initialized = "$MAGENTA бот ініціалізовано."
log_tg_started = "$CYAN бот $YELLOW@{}$CYAN запущено."
log_tg_handler_error = "Сталася помилка під час виконання обробника  бота."
log_tg_update_error = "Сталася помилка ({}) під час отримання оновлень  (введено некоректний токен?)."
