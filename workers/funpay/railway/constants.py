...
ACCOUNT_TIMER_NOTE = (
    "⏱️ Отсчет аренды начнется после первого получения кода (!код). Если код не запросить 10 минут, аренда начнется автоматически.",
)
RENTAL_STARTED_MESSAGE = (
    "⏱️ Аренда началась сейчас (с момента получения кода)."
)
RENTAL_CODE_AUTO_START_MESSAGE = (
    "⏳ Прошло 10 минут без запроса кода (!код), аренда началась автоматически.",
)
COMMANDS_RU = (
    "Команды:\n"
    "!акк — данные аккаунта\n"
