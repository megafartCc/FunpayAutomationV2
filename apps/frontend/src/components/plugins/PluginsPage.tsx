      ...
      <div className="flex flex-col gap-6">
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm shadow-neutral-200/70">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold text-neutral-900">Auto Raise (FunPay)</h3>
              <p className="text-xs text-neutral-500">
                Runs across <span className="font-semibold text-neutral-700">all FunPay workspaces</span> in sequence.
              </p>
            </div>
            <label className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-neutral-50 px-3 py-1 text-xs font-semibold text-neutral-600">
              <input
                type="checkbox"
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-[minmax(0,1fr)_minmax(0,220px)]">
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <div className="text-sm font-semibold text-neutral-900">Interval between workspaces</div>
                  <div className="text-xs text-neutral-500">
                    Wait time before moving to the next workspace.
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4">
              <div className="text-xs font-semibold text-neutral-500">Selected games</div>
              <div className="mt-2 text-3xl font-semibold text-neutral-900">{selectedGamesCount}</div>
              <div className="mt-2 text-xs text-neutral-500">
                Auto raise will only run for the games you enable below.
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            {loading ? <span className="text-xs text-neutral-400">Loading settings...</span> : null}
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm shadow-neutral-200/70">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h3 className="text-lg font-semibold text-neutral-900">Games to auto raise</h3>
              <p className="text-xs text-neutral-500">
                Choose the FunPay games you want to raise. ({selectedGamesCount} selected)
              </p>
            </div>
