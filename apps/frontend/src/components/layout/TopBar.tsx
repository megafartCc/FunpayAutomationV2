...
const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-10 border-b border-neutral-200 bg-white px-4 py-4 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3 lg:gap-4">
          ...
          <label className="relative flex h-10 w-full items-center gap-3 rounded-lg border border-neutral-200 bg-neutral-50 px-4 text-sm text-neutral-500 shadow-sm shadow-neutral-200 sm:w-72">
